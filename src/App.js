...
class App extends Component {
  ...
  render() {
    ...
    const {logStatus, currentUser} = this.state 
      ...
      <>
        <Router>
          <Switch>
            ...
            <Route path="/users" element={currentUser.hasOwnProperty('role') && currentUser.role === 0 ? <Users user={this.state.currentUser} log={this.log.bind(this)} /> : <Page404 />} />
          </Switch>
        </Router>
        <SweetAlert
